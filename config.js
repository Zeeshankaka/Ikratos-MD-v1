...
/*============== PAYMENT ==============*/
global.pdana = '923111054738' //Nomor Danamu
global.ppulsa = '923111054738' //Nomor SimCard Yang Kamu Pake
...
global.nameown = 'Zeeshan Ansari🇵🇰' // Nama Owner


/*============== STAFF ==============*/
global.owner = [
  ['923111054738', 'Zeesham Ansari🎐', true] //Replace your number with your name
...
/*============== WATERMARK ==============*/
global.wm = '                「 Zeeshan 𝙱𝙾𝚃 汉  」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘Ahmad Ali- ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ ɪᴋʀᴀᴛᴏs 𝙱𝙾𝚃'
global.botdate = `⫹⫺ Date: ${week} ${date}`
global.bottime = `Time : ${wktuwib}`
global.titlebot = '🎋 ┊ Zeeshan ʙᴏᴛ ᴡʜᴀᴛsᴀᴘᴘ'
...
global.packname2 = 'ᴄʀᴇᴀᴛᴇᴅ ʙʏ Zeeshan'
